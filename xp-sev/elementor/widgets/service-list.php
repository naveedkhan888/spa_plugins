...
class Ovasev_Elementor_Service_List extends Widget_Base {
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .xp-service-list li.item a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .xp-service-list li.item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .xp-service-list li.item a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .xp-service-list .service-title-list li.item a',
					'condition' => [
						'template' => 'template1'
					]
				]
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .xp-service-list.template2 .service-title-list li.item a .service-title',
					'condition' => [
						'template' => 'template2'
					]
				]
	...
	protected function render() {
		...
		?>
            ...
            <div class="xp-service-list <?php echo esc_attr($template);?>">
