var file_frame;
jQuery(document).on('click', '.xp_metabox_gallery a.gallery-add', function(e) {
   e.preventDefault();
...
jQuery(document).on('click', '.xp_metabox_gallery  a.change-image', function(e) {
  e.preventDefault();
...
jQuery(document).on('click', '.xp_metabox_gallery a.remove-image', function(e) {
   e.preventDefault();
